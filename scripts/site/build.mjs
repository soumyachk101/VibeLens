...
<main class="home" id="content">
  <section class="hero">
    <div class="hero-inner">
      ...
      <div class="hero-terminal" data-copy-cmd="claude plugin marketplace add soumyachk101/VibeLens">
        <div class="terminal-bar">
          ...
          <span class="terminal-title">bash — install plugin</span>
          <div class="terminal-copy-badge">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" width="13" height="13" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
            <span class="badge-txt">Click to copy</span>
          </div>
        </div>
